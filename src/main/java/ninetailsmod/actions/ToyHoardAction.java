...
public class ToyHoardAction extends AbstractGameAction {
    private boolean retrieveCard = false;

    public ToyHoardAction(int amount) {
    ...
    public void update() {
        ArrayList<AbstractCard> generatedCards = generateToyCardChoices();
    ...
    private ArrayList<AbstractCard> generateToyCardChoices() {
        ArrayList<AbstractCard> derp = new ArrayList<>();
        while (derp.size() != 3) {
            boolean dupe = false;
            AbstractCard tmp = getToyCard();
