...
public class LaserEyes extends BaseCard {

    public static final String ID = makeID(LaserEyes.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
