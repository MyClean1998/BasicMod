...
public class UncommonCard1 extends BaseCard {

    public static final String ID = makeID("UncommonCard1"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
