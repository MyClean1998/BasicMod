...
public class RareCard1 extends BaseCard {

    public static final String ID = makeID("RareCard1"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
