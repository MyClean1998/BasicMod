...
public class FrenziedClaw extends BaseCard {

    public static final String ID = makeID(FrenziedClaw.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public static boolean isClaw(AbstractCard c) {
        return c.hasTag(CustomTags.CLAW);
    }
}
