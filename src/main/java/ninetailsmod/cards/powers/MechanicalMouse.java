...
import ninetailsmod.powers.MechanicalMousePower;
import ninetailsmod.util.CardStats;

public class MechanicalMouse extends BaseCard {

    public static final String ID = makeID(MechanicalMouse.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new MechanicalMousePower(p, 1)));
    }
}
