...
import ninetailsmod.powers.ProfilePicPower;
import ninetailsmod.util.CardStats;

public class ProfilePic extends BaseCard {

    public static final String ID = makeID(ProfilePic.class.getSimpleName()); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new ApplyPowerAction(p, p, new ProfilePicPower(p, 1)));
    }
}
