...
public class UncommonCard3 extends BaseCard {

    public static final String ID = makeID("UncommonCard3"); //makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
